    ...
    <Card className="p-4">
      <div className="mb-3 flex items-baseline justify-between">
        <div className="flex items-baseline gap-2">
          <h3 className="m-0 text-[15px] font-semibold">Pipeline de medições</h3>
      ...
      <div role="list" aria-label="Funil do pipeline" className="space-y-2">
        {stages.map((s) => {
          ...
          return (
            <Link
              ...
              role="listitem"
              title={s.tip}
              className="block rounded-md no-underline text-inherit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
