const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/mermaid.core-wAL4OZIo.js","assets/index-D5rGU6p9.js","assets/index-CZ8qDAnq.css","assets/purify.es-8E279hYE.js"])))=>i.map(i=>d[i]);
import{af as i,_ as p,ab as o,P as f}from"./index-D5rGU6p9.js";const u=`
<pre class="mermaid">
flowchart TD
...
gantt
  ...
  `};function N(){const[s,c]=i.useState("inicio"),r=i.useRef(null);i.useEffect(()=>{let a=!1;return(async()=>{if(r.current)try{const m=(await p(async()=>{const{default:t}=await import("./mermaid.core-wAL4OZIo.js").then(l=>l.aH);return{default:t}},__vite__mapDeps([0,1,2,3]))).default;if(a)return;const e=r.current.querySelectorAll("pre.mermaid:not([data-processed])");if(e.length===0)return;e.forEach((t,l)=>{t.id=`mmd-${s}-${l}-${Date.now()}`,t.removeAttribute("data-processed")}),await m.run({nodes:e})}catch{}})(),()=>{a=!0}},[s]);const d=n[s]??n.inicio;return o.jsxs("div",{className:"man-root",children:[o.jsx(f,{title:"📖 Manual do Usuário",subtitle:"Guia completo do sistema com fluxogramas"}),o.jsxs("div",{className:"man-layout",children:[o.jsx("div",{className:"man-menu",children:R.map(a=>o.jsxs("button",{type:"button",className:`man-menu-item${s===a.k?" active":""}`,onClick:()=>c(a.k),children:[o.jsx("span",{children:a.icon}),o.jsx("span",{children:a.label})]},a.k))}),o.jsx("div",{ref:r,className:"man-content",dangerouslySetInnerHTML:{__html:d}})]})]})}export{N as default};
//# sourceMappingURL=Manual-C32PRqlV.js.map
