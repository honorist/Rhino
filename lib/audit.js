...
// Resolve nome amigável de uma entidade qualquer (clientes/recursos/contracts/etc)
...
async function log({ req, res, body, status, durationMs, requestId }) {
  try {
    ...
    // Nome amigável: prioridade pro que o handler setou; senão tenta extrair do before; senão do body (POST)
