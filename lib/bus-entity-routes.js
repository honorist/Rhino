...
const ENTITY_ROUTE = {
  ...
  'ordens-compra': '#/mapa-cotacoes',
  subcontratados: '#/subcontratados',
  users: '#/usuarios',
  'niveis-acesso': '#/usuarios',
  'case-logos': '#/apresentacao',
  'app-settings': '#/apresentacao',
  'doc-templates': '#/configuracao',
  'tipos-base': '#/configuracao',
  'cobranca-mensal': '#/cobranca',
  saidas: '#/contratos',
};
