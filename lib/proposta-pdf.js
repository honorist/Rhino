...
function _gerarPdfPrincipal(p) {
  return new Promise((resolve, reject) => {
    try {
      ...
      let pageIndex = 0;
      // Flag anti-recursão: drawBackground/drawPageNumber chamam text/image
      // que, quando o cursor está perto do limite, DISPARAM pageAdded de novo.
      // Sem essa flag, o evento aninha em loop infinito (stack overflow).
