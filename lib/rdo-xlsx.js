...
// Helpers puros exportados para teste (parse/format que alimentam a planilha).
module.exports = { preencherRdoXlsx, _fmtBR: fmtBR, _asObj: asObj, _asArr: asArr, _norm: norm };
