 ...
 * @param {Array<{buf:Buffer, legenda:string}>} [fotos]  fotos já reduzidas
 * @returns {Promise<Buffer>}  o .xlsx preenchido
 */
async function preencherRdoXlsx(rdo, contract = {}, fotos = []) {
