...
module.exports = {
  ...
  /**
   * Imagem de fundo da página A4 (timbrado completo Rhino).
   * Extraída do Template.dotx: 1654x2339 px = página A4 inteira.
   * No PDF, desenhada em cada página (0,0) cobrindo página toda;
   * o conteúdo textual fica POR CIMA dela, com margem esquerda larga
   * pra dar espaço pra logo+decoração que ocupam o lado esquerdo.
   */
  PAGINA_BG: {
    PATH: path.join(__dirname, '..', 'assets', 'proposta-bg.jpg'),
  },
  /**
