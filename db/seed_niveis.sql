INSERT INTO niveis_acesso (id, label, icon, cor, abas) VALUES
  ('admin',      'Administrador', 'shield',     '#55588B', '["#/dashboard","#/contratos","#/caixa","#/notas-fiscais","#/contas-pagar","#/socios","#/investimentos","#/clientes","#/fornecedores","#/recursos","#/base","#/obras","#/frota","#/solicitacoes-compra","#/auditoria","#/configuracao","#/usuarios","solicitacoes-compra:avaliar","solicitacoes-compra:aprovar","solicitacoes-compra:receber","contrato-tab:visao","contrato-tab:financeiro","contrato-tab:equipe","contrato-tab:rdo","contrato-tab:pendencias"]'::jsonb),
